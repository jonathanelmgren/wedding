...
const guestsAlbumId = "AJlFrfFXuAR7JBC23vE2-2xrqTY30AhO_UQNHwVt0oBwoCWe55nLui58pRLCPAREhKAlneaBLkCf"
...
export const uploadImages = async (formData: FormData): Promise<boolean> => {
    try {
        ...
        const batch = await fetch('https://photoslibrary.googleapis.com/v1/mediaItems:batchCreate', {
            headers: {
