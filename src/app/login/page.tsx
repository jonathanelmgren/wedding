  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen w-screen">
      ...
      <form action={login} className="flex">
        ...
        <button className="border-primary border-l-0 border-[1px] px-4 bg-primary text-white rounded-r-md">
          OK
        </button>
      </form>

      {searchParams.error && <p className="mt-4 text-red-500">Fel kod</p>}
    </div>
  );
};
